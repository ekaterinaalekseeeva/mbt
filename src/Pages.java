...
public class Pages {
    ...
    private void addFSI(){
        ...
        ArrayList<String> termElems = new ArrayList<String>(Arrays.asList(Constants.Elements.terminalElements));

        ArrayList<String> ignElems = new ArrayList<String>(Arrays.asList(Constants.Elements.ignoredElements));


        Page tmpPage = new Page(page, url, termElems, ignElems);
        tmpPage.necessaryElementsSelectors = new ArrayList<String>();
