...
//        nesElems.add("li > a[id*='ommand']");
        ...
        ignElems.add("button[id*='addFileMenu']");
        ignElems.add("button[id*='addFileMenu'] span");
...
//        ignElems.add("div[id='id_l.I.ic.it.c.ac.newComment'] > button[id='id_l.I.ic.it.c.ac.addFileMenu'] > span[class*='comment-attach-ico']");
        ignElems.add("a[id*='attachImageAndEdit']");
        ignElems.add("a[id*='uploadFileSecurely']");
        ignElems.add("a[id*='uploadFile']");
